...
/**
 * Application Use Case: List Doctor's Appointments (Query).
 */
@Component
...
public class ListDoctorAppointmentsUseCase {
    ...
    @Cacheable(value = "appointments", key = "'doctor_' + #doctorId + '_page_' + #page + '_' + #size + '_' + #sortBy + '_' + #sortDir")
    public PageResponse<AppointmentResponse> execute(Long doctorId, int page, int size, String sortBy, String sortDir) {
        log.debug("UC: Listing doctor appointments - doctorId={}, page={}", doctorId, page);
